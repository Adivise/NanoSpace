...
module.exports = { 
    ...
    run: async (client, message, filter) => {
        const msg = await message.channel.send("Turning on `TrebleBass` please wait...");
        ...
        const tbed = new MessageEmbed()
            .setAuthor("Turn on filter: TrebleBass", 'https://cdn.discordapp.com/emojis/758423098885275748.gif')
            .setColor('#000001');
